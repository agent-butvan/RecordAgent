...
export const JournalEditorPage: React.FC<JournalEditorPageProps> = ({ date, initialJournal, onBack, onSave }) => {
  ...
  return <WritingEditorPage backLabel="日历" identity="手记" detail={dateLabel}
    initialTitle={initialJournal?.title} initialBody={initialJournal?.excerpt} onBack={onBack}
